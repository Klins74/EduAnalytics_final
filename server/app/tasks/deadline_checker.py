...
class DeadlineChecker:
    ...
    async def check_deadlines(self, db: Session) -> None:
    ...
    async def _check_deadlines_for_interval(self, db: Session, hours: int) -> None:
    ...
    async def _send_deadline_notification(self, db: Session, assignment: Assignment, hours: int) -> None:
    ...
    async def _get_course_students(self, db: Session, course_id: int) -> List[dict]:
    ...
    async def check_single_assignment(self, db: Session, assignment_id: int) -> bool:
